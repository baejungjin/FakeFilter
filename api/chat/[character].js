...
**설득률 계산 기준**: 
- 각 편향(확증편향, 권위편향, 선택편향, 생존자편향)당 25%씩 배점
- 편향이 완전히 약화되면 25%, 부분 약화되면 12.5%, 변화 없음 0%
- 추가로 대화 질, 논리성, 공감 시도 등을 종합하여 최종 퍼센트 산출
- 예: 2개 편향 완전 약화 + 좋은 소통 = 60%, 1개 편향 부분 약화 + 보통 소통 = 25%
